...
<form method="post" action="test.php" name="form1">
  ...
  <table border="0" cellpadding="0" cellspacing="0" align="center">
    ...
    <tr>
      ...
      <input type="radio" name="test_type" value="mcq" checked="checked" onClick="getquerystring(this.value)"> MCQ
    ...
    </tr>	<tr><td> Show Answers </td> <td><input type='checkbox' name='show_ans' value='y' checked='checked'> 



    [applicable in mcq]</td>
    ...
    <tr>
      ...
      <td width="112" height="35">Class</td>
    ...
    <select name="class" id="cls" onChange="getSubject(this.value)" style="background-color:#11E964">
  ...
  <?php while ($row=mysql_fetch_array($result)) {
    ...
    <tr style="">
      ...
      <td ><div id="subjectdiv">
        ...
        <select id="sub" name="subject"  style="background-color:#11E964">
...
<? /*     
  ...
  <tr style="">
    ...
    <td ><div id="questiondiv">



           <input name="totq" type="text" size="10" readonly="true" value=""/>
        ...
        <td >Select questions: 
          ...
          <td><input name="noq" type="text" value="5" size="5" maxlength="10" /> 



          [Give number of questions comprising of this test] </td>
...
?>	  
  ...
  <tr>
    ...
    <td>&nbsp;</td>
      ...
      <td><input type="submit" name="submit" value="Generate Test" />
      
      <input type="submit" name="quiz" value="Take Test" /></td> 
