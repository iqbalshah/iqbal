...
If you refresh the page
   ...
   then the timer will not stopped and remain continue to count down until finished. 
...
function calculate_time()
{
 ...
 document.getElementById("timer").value = mins + ":" + secs; // Display remaining minutes and seconds.
