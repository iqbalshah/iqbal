<?php		//mysql_query("SET character_set_results=utf8", $connection);		mb_language('uni');		mb_internal_encoding('UTF-8');		//mysql_select_db('test', $dbLink);		//mysql_query("set names 'utf8'",$connection);function safe_output($string) {		if (empty($string)) { return ''; }		return htmlentities(strip_tags($string));	}// A function to return the Roman Numeral, given an integer
